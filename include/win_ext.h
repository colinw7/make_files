...
*  Date     | Change
*-----------+-----------------------------------------------------------------
* 22-Dec-97 | Created change log
* 22-Dec-97 | Fixed unbalanced parentheses
*           | Added Button_SetImage, Button_GetImage
*           | Note: still not VC++ 5.0 compatible
* 19-Sep-98 | WM_CONTEXTMENU, WM_DISPLAYCHANGE now conditional for VC++ 5.0
*****************************************************************************/
...
/* HANDLE Button_GetImage(HWND hwnd, int imagetype) */
#define Button_GetImage(hwnd, imagetype) \
    (HANDLE)SendMessage((hwnd), BM_GETIMAGE, (WPARAM)(imagetype), 0)

/* HANDLE Button_SetImage(HWND hwnd, int imagetype, HANDLE himage) */
#define Button_SetImage(hwnd, imagetype, himage) \
    (HANDLE)SendMessage((hwnd), BM_SETIMAGE, (WPARAM)(imagetype), \
